...
var cleanup_ts_1 = require("./cleanup.ts");
var MessageScheduler = /** @class */ (function () {
     ...
     */
    MessageScheduler.startDailyCleanup = function () {
        var _this = this;
     ...
     */
    MessageScheduler.stopDailyCleanup = function () {
     ...
     */
    MessageScheduler.runCleanup = function () {
        return __awaiter(this, void 0, void 0, function () {
            var deactivatedCount, stats, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        console.log("Starting daily message cleanup...");
                        return [4 /*yield*/, cleanup_ts_1.MessageCleanup.deactivateOldMessages()];
                    case 1:
                        deactivatedCount = _a.sent();
                        return [4 /*yield*/, cleanup_ts_1.MessageCleanup.getMessageStats()];
                    case 2:
                        stats = _a.sent();
                    ...
                    case 3:
                        error_1 = _a.sent();
                        console.error("Error during daily cleanup:", error_1);
                        return [3 /*break*/, 4];
    ...
    MessageScheduler.cleanupInterval = null;
